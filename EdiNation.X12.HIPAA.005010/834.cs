namespace EdiNation.X12.HIPAA005010
{
    ...
    public class Loop_2100B_834
    {
        ...
        public DMG_IncorrectMemberDemographics DMG_IncorrectMemberDemographics;
    }
    public class Loop_2100C_834
    {
        ...
        public N4_AdditionalPatientInformationContactCity N4_MemberMailCity_State_ZIPCode;
    }
    public class Loop_2100D_834
    {
        ...
        public N4_AdditionalPatientInformationContactCity N4_MemberEmployerCity_State_ZIPCode;
    }
    public class Loop_2100E_834
    {
        ...
        public N4_AdditionalPatientInformationContactCity N4_MemberSchoolCity_State_ZIPCode;
    }
    public class Loop_2100F_834
    {
        ...
        public N4_AdditionalPatientInformationContactCity N4_CustodialParentCity_State_ZIPCode;
    }
    public class Loop_2100G_834
    {
        ...
        public N4_AdditionalPatientInformationContactCity N4_ResponsiblePersonCity_State_ZIPCode;
    }
    public class Loop_2100H_834
    {
        public NM1_DropOffLocation NM1_DropOffLocation;
        public N3_AdditionalPatientInformationContactAddress N3_DropOffLocationStreetAddress;
        public N4_AdditionalPatientInformationContactCity N4_DropOffLocationCity_State_ZIPCode;
    }
    ...
    public class Loop_2310_834
    {
        ...
        public List<N3_AdditionalPatientInformationContactAddress> N3_ProviderAddress;
    ...
    public class Loop_2330_834
    {
        ...
        public N3_AdditionalPatientInformationContactAddress N3_CoordinationofBenefitsRelatedEntityAddress;
        public N4_AdditionalPatientInformationContactCity N4_CoordinationofBenefitsOtherInsuranceCompanyCity_State_ZIPCode;
    ...
    public class Loop_2750_834
    {
        ...
        public REF_ReportingCategoryReference REF_ReportingCategoryReference;
        public DTP_CertificationEffectiveDate DTP_ReportingCategoryDate;
    }
